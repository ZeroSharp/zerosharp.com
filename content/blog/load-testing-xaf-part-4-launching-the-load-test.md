...
date = 2013-04-08T11:19:00+01:00
slug = "load-testing-xaf-part-4-launching-the-load-test"
categories = ["c#", "devexpress", "xaf", "aws", "neustar"]
description = "How to launch a load test using NeuStar Web Performance Management."
disqus_identifier = "http://ZeroSharp.github.com/load-testing-xaf-part-4-launching-the-load-test/"
disqus_url        = "http://ZeroSharp.github.com/load-testing-xaf-part-4-launching-the-load-test/"
+++
...
![](/images/blog/load-testing/load-testing-005.png)
