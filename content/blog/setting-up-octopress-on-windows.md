...
date = 2012-04-06T17:11:00+01:00
slug = "setting-up-octopress-on-windows"
categories = ["octopress", "github"]
description = "How to set up Octopress on Windows and host your blog with GitHub."
disqus_identifier = "http://ZeroSharp.github.com/setting-up-octopress-on-windows/"
disqus_url        = "http://ZeroSharp.github.com/setting-up-octopress-on-windows/"
+++
> <div STYLE="color:red">There is a more recent version of this post which covers ruby 1.9.3, python 2.7.3.</div>
>
> — January 2013 update: http://blog.zerosharp.com/setting-up-octopress-on-windows-again Setting up Octopress on Windows again
...
![](/images/blog/octopress_logo.png) 
