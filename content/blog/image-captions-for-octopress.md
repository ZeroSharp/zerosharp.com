...
date = 2013-01-23T11:56:00+01:00
slug = "image-captions-for-octopress"
categories = ["octopress"]
description = "How to add pretty captions to images in Octopress."
disqus_identifier = "http://ZeroSharp.github.com/image-captions-for-octopress/"
disqus_url        = "http://ZeroSharp.github.com/image-captions-for-octopress/"
+++
  ...
  class CaptionImageTag < Liquid::Tag
    ...
    def render(context)
      ...
      if @img
        ...
        "Error processing input, expected syntax: ![name(s)] /url/to/image [width height] [title text]]([class)"
      end
    end
  end
end
