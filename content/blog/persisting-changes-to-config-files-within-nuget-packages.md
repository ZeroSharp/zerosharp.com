...
date = 2014-08-13T06:39:00+01:00
slug = "persisting-changes-to-config-files-within-nuget-packages"
categories = ["c#", "nuget", "msbuild"]
description = "Use an MSBuild target to make automatic changes to any xml file."
disqus_identifier = "http://ZeroSharp.github.com/persisting-changes-to-config-files-within-nuget-packages/"
disqus_url        = "http://ZeroSharp.github.com/persisting-changes-to-config-files-within-nuget-packages/"
+++
